...
laser_graphical_display() {
    ...
    pub_laser_graphical_display_marker = n.advertise<visualization_msgs::Marker>("laser_graphical_display", 1); // Preparing a topic to publish our results. This will be used by the visualization tool rviz
...
void populateMarkerReference() {
    ...
    pub_laser_graphical_display_marker.publish(references);
...
void populateMarkerTopic(){
    ...
    pub_laser_graphical_display_marker.publish(marker);
...
int main(int argc, char **argv){
    ...
    ros::init(argc, argv, "laser_graphical_display");

    laser_graphical_display bsObject;
